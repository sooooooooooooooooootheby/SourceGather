<template>
    <div class="box">
        <div class="element">
            <!-- <ul ref="ul" v-on:mouseover="touchOver" v-on:mouseout="touchOut">
                <li ref="li" v-on:mouseover="event.preventDefault()" v-on:mouseout="event.preventDefault()">
                    <span class="fontBG" ref="fontBG">
                        {{ BGColor }}
                    </span>

                    <div class="font SourceHanSands">
                        <p>
                            昨夜雨疏风骤，浓睡不消残酒。
                            <br />
                            试问卷帘人，却道海棠依旧。
                    ...
                    <div class="fontName" ref="fontName">
                        <span>思源黑体(SourceHanSands)</span>
                        |
                        <span>ExtraLight</span>
                        <span>Light</span>
                        <span>Normal</span>
                        <span>Regular</span>
                        <span class="pitch">Medium</span>
                        <span>Bold</span>
                        <span>Heavy</span>
                    </div>
                </li>

                <li ref="li" v-on:mouseover="touchFontOver" v-on:mouseout="touchFontOut">
                    <span class="fontBG" ref="fontBG">
                        {{ BGColor }}
                    </span>

                    <div class="font SourceHanSerif">
                        <p>山重水复疑无路，柳暗花明又一村。</p>
                    </div>

                    <div class="fontName" ref="fontName">
                        <span>思源宋体(SourceHanSerif)</span>
                        |
                        <span>ExtraLight</span>
                        <span>Light</span>
                        <span>Normal</span>
                ...
                <li ref="li" v-on:mouseover="touchFontOver" v-on:mouseout="touchFontOut">
                    ...
                    <div class="font jf-openhuninn">
                        <p>落霞与孤鹜齐飞，秋水共长天一色</p>
                    </div>

                    <div class="fontName" ref="fontName">
                        <span>open 粉圆(jf-openhuninn-2.0)</span>
                    </div>
                </li>
                <li ref="li" v-on:mouseover="touchFontOver" v-on:mouseout="touchFontOut">
                    <span class="fontBG" ref="fontBG">
                    ...
                    <div class="font SarasaFixedSlabSC">
                        <p>
                            明月几时有？把酒问青天。
                            <br />
                            不知天上宫阙，今夕是何年。
                    ...
                    <div class="fontName" ref="fontName">
                        <span>更纱黑体(Sarasa Gothic)</span>
                        |
                        <span>ExtraLight</span>
                        <span>Light</span>
                        <span class="pitch">Regular</span>
                        <span>Bold</span>
                        <span>SemiBold</span>
                    </div>
                </li>
                ...
                <li ref="li" v-on:mouseover="touchFontOver" v-on:mouseout="touchFontOut">
                    ...
                    <div class="fontName" ref="fontName">
                        ...
                        |
                        <span>light</span>
                        <span>lightitalic</span>
                        <span>regular</span>
                        <span>italic</span>
                        <span class="pitch">medium</span>
                        <span>mediumitalic</span>
                        <span>bold</span>
                        <span>bolditalic</span>
                    </div>
                </li>
            </ul> -->
            <ul ref="ul">
